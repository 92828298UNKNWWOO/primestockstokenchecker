...
def log(message, **kwargs):
    ...
    print(
        f"{colorama.Fore.LIGHTBLACK_EX}[{colorama.Fore.LIGHTMAGENTA_EX}{time.strftime('%H:%M:%S', time.localtime())}{colorama.Fore.LIGHTBLACK_EX}] "
        f"{colorama.Fore.LIGHTBLACK_EX}[{colorama.Fore.LIGHTMAGENTA_EX}Prime Stocks{colorama.Fore.LIGHTBLACK_EX}] "
